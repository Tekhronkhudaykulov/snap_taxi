...
// node_modules/reactotron-react-js/dist/index.js
var require_dist2 = __commonJS({
  "node_modules/reactotron-react-js/dist/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var reactotronCoreClient = require_dist();
    var StackTrace = require_stacktrace();
    function _interopDefaultLegacy(a) {
      return a && "object" == typeof a && "default" in a ? a : { default: a };
    }
    var StackTrace__default = _interopDefaultLegacy(StackTrace);
    function _typeof(a) {
    ...
    var PLUGIN_DEFAULTS = { offline: false };
    var trackGlobalErrors = function(a) {
      return function(b) {
        function c(a2, c2, d2, e2, h2) {
          StackTrace__default["default"].fromError(h2, { offline: f.offline }).then(function(c3) {
            return b.error(a2, c3);
          })["catch"](function(f2) {
            return b.error({ message: CANNOT_RESOLVE_ERROR, original: { msg: a2, file: c2, line: d2, col: e2, error: h2 }, resolvingError: f2 });
          }), g && g(a2, c2, d2, e2, h2);
        }
        function d() {
          h || (g = window.onerror, window.onerror = c, h = true);
        }
        function e() {
          g && (window.onerror = g, h = false);
        }
        var f = Object.assign({}, PLUGIN_DEFAULTS, a || {}), g = null, h = false;
        return d(), { features: { trackGlobalErrors: d, untrackGlobalErrors: e } };
      };
    };
    ...
    function getNavigatorProperty(a) {
      return a ? isBrowser() ? window.navigator || "object" === _typeof(window.navigator) ? window.navigator[a] : void 0 : void 0 : void 0;
    }
    var DEFAULTS = { createSocket: function(a) {
      return new WebSocket(a);
    }, host: "localhost", port: 9090, name: "React JS App", client: {}, getClientId: function() {
    ...
    isBrowser() && (DEFAULTS.client = { reactotronLibraryName: "reactotron-react-js", reactotronLibraryVersion: "2.1.1", platform: "browser", platformVersion: getNavigatorProperty("platform"), userAgent: getNavigatorProperty("userAgent"), screenWidth: screen && screen.width || void 0, screenHeight: screen && screen.height || void 0, screenScale: window && window.devicePixelRatio || 1, windowWidth: window && window.innerWidth || void 0, windowHeight: window && window.innerHeight || void 0 });
    var index = reactotronCoreClient.createClient(DEFAULTS);
    exports["default"] = index, exports.trackGlobalErrors = trackGlobalErrors;
  }
});
export default require_dist2();
//# sourceMappingURL=reactotron-react-js.js.map
