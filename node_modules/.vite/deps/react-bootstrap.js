...
} from "./chunk-7XJVFQWS.js";
import {
  Button_default as Button_default2
} from "./chunk-CIAYI2D6.js";
import {
  Button_default
} from "./chunk-5IYOSP3Y.js";
import {
...
function useForceUpdate() {
  var _useReducer = (0, import_react13.useReducer)(function(state) {
    return !state;
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react14.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
function useDropdownMenu(options = {}) {
  const context6 = (0, import_react17.useContext)(DropdownContext_default);
...
function Dropdown({
  ...
  const context6 = (0, import_react21.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var NavLink = React63.forwardRef(({
  ...
  return (0, import_jsx_runtime59.jsx)(Component2, {
    ...
    ...navItemProps,
    ref,
    className: (0, import_classnames41.default)(className, bsPrefix, props.disabled && "disabled", meta.isActive && "active")
  });
});
NavLink.displayName = "NavLink";
NavLink.defaultProps = defaultProps17;
...
Nav2.defaultProps = defaultProps18;
...
NavbarToggle.defaultProps = defaultProps19;
...
OffcanvasToggling.defaultProps = defaultProps20;
...
OffcanvasHeader.defaultProps = defaultProps21;
...
var Offcanvas = React70.forwardRef(({
  ...
  const renderBackdrop = (0, import_react42.useCallback)((backdropProps) => (0, import_jsx_runtime66.jsx)("div", {
    ...backdropProps,
...
Offcanvas.defaultProps = defaultProps22;
...
Navbar.defaultProps = defaultProps23;
...
var Overlay = React74.forwardRef((props, outerRef) => {
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime73.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
Popover.defaultProps = defaultProps24;
...
Overlay2.defaultProps = defaultProps25;
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime79.jsxs)(import_jsx_runtime78.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react49.cloneElement)(children, triggerProps), (0, import_jsx_runtime77.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
OverlayTrigger.defaultProps = defaultProps26;
...
var ToastContainer = React99.forwardRef(({
  ...
  return (0, import_jsx_runtime103.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames63.default)(bsPrefix, position && [containerPosition ? `position-${containerPosition}` : null, positionClasses[position]], className)
  });
});
